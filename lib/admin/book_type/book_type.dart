...
class _BookTypePageState extends State<BookTypePage> {
  ...
  List<BookTypeSnapshot> fullList = [];
  List<BookTypeSnapshot> filteredList = [];
  @override
  Widget build(BuildContext context) {
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(
            builder: (context) => AddBookTypePage(),
          ));
        },
      ),
      body: Padding(
            ...
            return Column(children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  setState(() {
                    filteredList = fullList.where((bookType) {
                      return bookType.bookType.name
                          .toLowerCase()
                          .contains(keyword);
                    }).toList();
                  });
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    var bookTypeSnapshot = filteredList[index];
                    return Slidable(
                      child: Container(
                        width: w,
                        height: 50,
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            onPressed: (context) {
                              Navigator.of(context).push(MaterialPageRoute(
                                builder: (context) => UpdateBookTypePage(
